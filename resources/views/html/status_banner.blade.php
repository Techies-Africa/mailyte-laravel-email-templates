        ...
        <td style="padding:{{ $props['space_above'] }} 0 {{ $props['space_below'] }};">
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                <tr>
                    ...
                    <td bgcolor="{{ $props['background'] }}" style="padding:14px 16px;background-color:{{ $props['background'] }};font-family:{{ $t['font.body'] }};font-size:{{ $props['type']['size'] ?? '16px' }};line-height:{{ $props['type']['line_height'] ?? '26px' }};color:{{ $props['color'] }};">
