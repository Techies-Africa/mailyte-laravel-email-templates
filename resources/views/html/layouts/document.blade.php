...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="{{ $locale ?? 'en' }}" dir="{{ $direction ?? 'ltr' }}">
<head>
    <meta charset="utf-8">
